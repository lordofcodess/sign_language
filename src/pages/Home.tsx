        ...
        <div className="relative h-full flex flex-col items-center justify-center px-6 z-10">
          <div className="text-center text-white mb-8">
            ...
            <p className="text-2xl md:text-4xl font-light drop-shadow-lg mb-4">
              Connect in Your Local Language
            </p>
      ...
      <div className="bg-white py-16">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-gray-600 text-lg mb-12 max-w-3xl">
            Practice Ghanaian Sign Language (GSL) and translate between sign
            language and local spoken languages with ease.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-xl p-8 border-2 border-green-500 shadow-lg hover:shadow-xl transition-shadow">
              <div className="flex items-center gap-4 mb-4">
                ...
                <h4 className="text-2xl font-bold text-green-600">Learn GSL</h4>
              </div>
              <p className="text-gray-600 mb-6">
                Start your Ghana Sign Language journey in a systematic, fun, and
                engaging way.
              </p>
              <button
                onClick={() => navigate("/learn")}
